        ...
        window.onload = function() {
            ...
            submitEle.onclick = function() {
                ...
                emialEle.focus();
                emialEle.blur();
                // if (passcode1Ele.value !== undefined && passcode2Ele.value !== undefined) {
                //     console.log(passcode1Ele.value)
                // }
                // 当所有表单都合法时
                if (nameEle.innerTxt !== "" && passcode1Ele.value !== "" && passcode2Ele.value !== "" && emialEle.innerTxt !== "" && usernameErrorSpan.innerText == "" && passcode2ErorrSpan.innerText == "" && emailErrorSpan.innerText == "") {
